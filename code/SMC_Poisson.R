...
likelihood=function(params){
  ...
  baseline_abundance_likelihood = sum(dpois(abundance_baseline$total_caught,
                                              lambda=f_control*catch_prop, log=T))
  intervention_abundance_control_likelihood = sum(
    dpois(abundance_intervention_control$total_caught,
            lambda=f_control*catch_prop,
            log=T))
  intervention_abundance_treatment_likelihood = sum(
    dpois(abundance_intervention_treatment$total_caught,
            lambda=fc_trt*catch_prop, log=T))
