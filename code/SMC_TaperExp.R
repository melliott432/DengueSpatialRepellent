...
samples = prior.samps
current.times = 1
part.kept = c(1, .5, .25, .25/2, .25/4, .25/8, .25/16, .25/32, .25/64, .25/128)
while(current.times <= times){
  hundreds=floor(current.times / 100) + 1
  res = sequential_mc_one_round(samples, part.kept[hundreds])
  samples = res[[1]]
