...
likelihood=function(params){
  ...
  return(epi_likelihood + intervention_parity_likelihood +
           intervention_abundance_control_likelihood + 
           intervention_abundance_treatment_likelihood + 
            intervention_fullyfed_likelihood + 
...
bloodmeal_baseline = read.csv(file="baseline_fed_unfed.csv")
bloodmeal_intervention = read.csv(file="intervention_fed_unfed.csv")
